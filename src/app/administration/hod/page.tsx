...
const HeadOfDepartments: React.FC = () => {
  const hods = [
    ...
    },
    {
      ...
      phone: "+91-866-2461566",
      office: "BSH Dept, Block A",
      image: "/bshhod.jpg",
    ...
    },
    {
      ...
      phone: "+91-866-2461571",
      office: "MBA Dept, Block G",
      image: "/mbaHosd1.jpeg",
