...
export default function NoticeboardPage() {
  ...
  const categories = [
    ...
    { value: 'fn', label: 'Fee Notifications' },
    { value: 'tt', label: 'Time Tables' }
  ];
      ...
      <div className="p-6">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <Link href="/exam-section/dashboard" className="flex items-center text-blue-600 hover:text-blue-800 hover:bg-blue-50 px-4 py-2 rounded-lg transition-all duration-200 border border-blue-200 font-medium">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-800">Noticeboard</h1>
              <p className="text-gray-600">Manage exam section notices and announcements</p>
            </div>
          </div>
        </div>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                          notice.category === 'results' ? 'bg-red-100 text-red-700' :
                          notice.category === 'fee notifications' ? 'bg-blue-100 text-blue-700' :
                          notice.category === 'timetables' ? 'bg-purple-100 text-purple-700' :
            ...
            <Card className="bg-gray-50">
              <CardContent className="p-12 text-center">
                ...
                <p className="text-gray-600 text-lg">
                  {searchTerm || selectedCategory !== 'all' ? 'No notices found' : 'No notices yet'}
                </p>
                <p className="text-gray-400 text-sm">
                  {!isAddingNew && 'Click "Add Notice" to create your first notice'}
                </p>
              </CardContent>
            </Card>
          )}
        ...
        <div className="mt-8 p-4 bg-blue-50 rounded-lg border border-blue-200">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-blue-600">{filteredNotices.length}</p>
            </div>
            <div>
              <p className="text-sm text-gray-600">Categories Used</p>
              <p className="text-2xl font-bold text-gray-800">{new Set(notices.map(n => n.category)).size}</p>
            </div>
            <div>
