          ...
          <CardContent>
            <Table>
              ...
              <TableBody>
                ...
                <TableRow>
                  <TableCell>
                    <div className="font-medium">Content Marketing 101</div>
                  </TableCell>
                  <TableCell className="text-right">986</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>
                    <div className="font-medium">React Server Components</div>
                  </TableCell>
                  <TableCell className="text-right">2,501</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>
                    <div className="font-medium">Designing for Accessibility</div>
                  </TableCell>
                  <TableCell className="text-right">850</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>
                    <div className="font-medium">The Rise of Jamstack</div>
                  </TableCell>
