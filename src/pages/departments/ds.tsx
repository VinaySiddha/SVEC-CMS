            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center mb-6">
              ...
              <div className="lg:col-span-2 space-y-4">
                <div className="mb-4">
                  ...
                  <p className="text-gray-600">Email: <a href="mailto:hod_aiml@srivasaviengg.ac.in" className="text-primary hover:underline">hod_aim@srivasaviengg.ac.in</a></p>
                </div>
              </div>
            </div>
    ...
    <div className="pt-24 bg-gray-100">
      <section className="bg-[#8B1919] text-white py-12">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h1 className="text-3xl md:text-4xl font-bold">Computer Science & Engineering - Data Science</h1>
          </div>
        </div>
      </section>
