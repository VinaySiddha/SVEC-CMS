...
import { Brain, BookOpen, Award, ExternalLink, Menu, ChevronRight } from 'lucide-react';
...
const AIMLDepartment: React.FC = () => {
  ...
  const faculty = [
    ...
    },
    {
      ...
      position: 'Professor',
      qualification: 'Ph.D in AI, M.Tech Computer Science',
      experience: '19+ years',
    ...
    },
    {
      ...
      qualification: 'M.Tech AI & ML, B.Tech CSE',
      experience: '15+ years',
      specialization: 'Reinforcement Learning, Computer Vision',
      image: 'https://images.pexels.com/photos/3785077/pexels-photo-3785077.jpeg?auto=compress&cs=tinysrgb&w=300'
    },
    {
      name: 'Dr. Neha Agarwal',
      position: 'Assistant Professor',
      qualification: 'Ph.D pursuing, M.Tech AI',
      experience: '11+ years',
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                      <div className="relative">
                        ...
                        <div className="absolute -bottom-4 -right-4 bg-[#B22222] text-white px-3 py-2 rounded-lg shadow-lg">
                          <p className="font-bold text-sm">24+ Years</p>
                          <p className="text-xs">Experience</p>
                        </div>
                      </div>
                      <div className="lg:col-span-2 space-y-4">
                        <div className="mb-6">
                          <h3 className="text-2xl font-bold text-[#B22222] mb-2">Dr. Vikram Singh</h3>
                          <p className="text-lg text-[#8B0000] font-medium mb-2">Head of Department, AI & ML</p>
                          <p className="text-gray-600">Ph.D in Machine Learning, M.Tech CSE</p>
                        </div>
                        <p className="text-gray-600 leading-relaxed">
                          "Welcome to the Department of Artificial Intelligence & Machine Learning at Sri Vasavi Engineering College. 
                          Our department is dedicated to advancing the frontiers of AI and ML through cutting-edge research, 
                          innovative teaching, and practical applications."
                        </p>
                        <p className="text-gray-600 leading-relaxed">
                          "We aim to develop the next generation of AI researchers and practitioners who will create intelligent 
                          systems that can learn, adapt, and solve complex problems. Our interdisciplinary approach combines 
            ...
            <section className="py-16 bg-white">
              <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                  ...
                  <p className="text-xl text-gray-600">AI & ML researchers and experts</p>
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-[#B22222] to-[#0097A7] text-white p-8 rounded-xl">
              <p className="text-lg leading-relaxed">
                "To be a globally recognized department of Artificial Intelligence & Machine Learning that produces competent 
                professionals with expertise in AI research, ML algorithms, and intelligent system design to serve 
                society and lead the AI revolution."
              </p>
            </div>
          </div>
        );
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-[#FFF8F0] p-6 rounded-xl">
                <h4 className="font-bold text-[#B22222] mb-3">M1: AI/ML Excellence</h4>
                <p className="text-gray-700">
                  To provide world-class education in artificial intelligence and machine learning 
                  through innovative pedagogical approaches and research-driven curriculum.
                </p>
              </div>
              <div className="bg-[#FFF8F0] p-6 rounded-xl">
                <h4 className="font-bold text-[#B22222] mb-3">M2: Cutting-edge Research</h4>
                <p className="text-gray-700">
                  To promote groundbreaking research in AI/ML areas including deep learning, 
                  reinforcement learning, and cognitive computing.
                </p>
              </div>
              <div className="bg-[#FFF8F0] p-6 rounded-xl">
                <h4 className="font-bold text-[#B22222] mb-3">M3: Industry Innovation</h4>
                <p className="text-gray-700">
                  To collaborate with industry leaders in AI/ML and provide students with 
                  exposure to real-world AI applications and challenges.
                </p>
              </div>
              <div className="bg-[#FFF8F0] p-6 rounded-xl">
                <h4 className="font-bold text-[#B22222] mb-3">M4: Responsible AI</h4>
                <p className="text-gray-700">
                  To develop students' understanding of ethical AI, fairness, and responsible 
                  machine learning practices for beneficial AI systems.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-[#B22222] pl-6 py-4">
                <h4 className="font-bold text-[#B22222] mb-2">PEO1: AI/ML Leadership</h4>
                <p className="text-gray-700">
                  Graduates will demonstrate leadership in AI/ML research and development 
                  through successful careers in academia, industry, or AI startups.
                </p>
              </div>
              <div className="border-l-4 border-[#0097A7] pl-6 py-4">
                <h4 className="font-bold text-[#B22222] mb-2">PEO2: Lifelong AI Learning</h4>
                <p className="text-gray-700">
                  Graduates will engage in continuous learning to stay at the forefront of 
                  rapidly evolving AI/ML technologies and methodologies.
                </p>
              </div>
              <div className="border-l-4 border-[#B22222] pl-6 py-4">
                <h4 className="font-bold text-[#B22222] mb-2">PEO3: Ethical AI Advocacy</h4>
                <p className="text-gray-700">
                  Graduates will champion ethical AI practices and responsible machine learning 
                  in their professional and research activities.
                </p>
              </div>
            </div>
          </div>
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                "AI knowledge: Apply knowledge of mathematics, statistics, and AI fundamentals.",
                "Problem analysis: Identify, formulate, and analyze complex AI/ML problems.",
                "Design/development: Design intelligent solutions for complex problems.",
                "Conduct investigations: Use research-based AI knowledge and methods.",
                "Modern tool usage: Create, select, and apply appropriate AI/ML tools.",
                "Engineer and society: Apply AI reasoning informed by societal context.",
                ...
                "Individual and team work: Function effectively in AI/ML development teams.",
                "Communication: Communicate effectively on complex AI/ML activities.",
                "Project management: Demonstrate knowledge of AI project management.",
                "Life-long learning: Recognize the need for continuous AI/ML learning."
              ].map((po, index) => (
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-r from-[#B22222]/10 to-[#0097A7]/10 p-6 rounded-xl">
                <h4 className="font-bold text-[#B22222] mb-3">PSO1: AI/ML Expertise</h4>
                <p className="text-gray-700">
                  Apply advanced knowledge of machine learning algorithms, neural networks, 
                  and AI techniques to build intelligent systems.
                </p>
              </div>
              <div className="bg-gradient-to-r from-[#0097A7]/10 to-[#B22222]/10 p-6 rounded-xl">
                <h4 className="font-bold text-[#B22222] mb-3">PSO2: Research Innovation</h4>
                <p className="text-gray-700">
                  Demonstrate ability to conduct original research in AI/ML and contribute to 
                  the advancement of artificial intelligence.
                </p>
              </div>
              <div className="bg-gradient-to-r from-[#B22222]/10 to-[#0097A7]/10 p-6 rounded-xl">
                <h4 className="font-bold text-[#B22222] mb-3">PSO3: AI Application Development</h4>
                <p className="text-gray-700">
                  Exhibit ability to design and develop AI applications across various domains 
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#FFF8F0] p-6 rounded-xl">
              <p className="text-gray-700 mb-4">
                ...
                should know and be able to do at the end of each AI/ML course.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="bg-white p-4 rounded-lg shadow">
                  <h4 className="font-bold text-[#B22222] mb-2">Core AI/ML Courses</h4>
                  <p className="text-sm text-gray-600">Machine Learning, Deep Learning, AI Fundamentals</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow">
                ...
                <div className="bg-white p-4 rounded-lg shadow">
                  <h4 className="font-bold text-[#B22222] mb-2">AI Specializations</h4>
                  <p className="text-sm text-gray-600">Robotics, AI Ethics, Cognitive Computing</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <h4 className="font-bold text-[#B22222] mb-3">Research-Driven Curriculum</h4>
                <p className="text-gray-700">Curriculum focused on cutting-edge AI/ML research</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg">
                <Brain className="w-12 h-12 text-[#B22222] mb-4" />
                <h4 className="font-bold text-[#B22222] mb-3">AI Research Centers</h4>
                <p className="text-gray-700">Dedicated research centers for AI and ML innovation</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg">
                <ExternalLink className="w-12 h-12 text-[#B22222] mb-4" />
                <h4 className="font-bold text-[#B22222] mb-3">Global AI Partnerships</h4>
                <p className="text-gray-700">Collaborations with leading AI research institutions</p>
              </div>
            </div>
          </div>
        );
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  <div className="text-3xl font-bold text-[#FFF8F0]">22+</div>
      ...
      <div className="relative">
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="border-b border-gray-200 mb-8">
            <h2 className="text-3xl font-bold text-gray-600 mb-4 text-center">AI & ML Department</h2>
