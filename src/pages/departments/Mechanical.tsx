            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
              ...
              <div className="lg:col-span-2 space-y-4">
                <div className="mb-4">
                  ...
                  <p className="text-gray-600">Email: <a href="mailto:hod_mech@srivasaviengg.ac.in" className="text-[#B22222] hover:underline">hod_mech@srivasaviengg.ac.in</a></p>
                </div>
                <p className="text-gray-700 leading-relaxed">
                  The Department of Mechanical Engineering is committed to providing excellent education and research opportunities in the field of mechanical engineering.
                </p>
              </div>
            </div>
