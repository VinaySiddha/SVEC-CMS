  ...
  const faculty = [
    {
      ...
      qualification: 'Ph.D in Thermal Engineering, M.Tech Mechanical',
      experience: '24+ years',
    ...
    },
    {
      ...
      position: 'Professor',
      qualification: 'Ph.D in Manufacturing, M.Tech Mechanical',
      experience: '19+ years',
    ...
    },
    {
      ...
      qualification: 'M.Tech Design, B.Tech Mechanical',
      experience: '13+ years',
    ...
    },
    {
      ...
      qualification: 'Ph.D pursuing, M.Tech Mechanical',
      experience: '8+ years',
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                      ...
                      <div className="lg:col-span-2 space-y-4">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                          "Welcome to the Department of Mechanical Engineering at Sri Vasavi Engineering College. 
                          Our department is dedicated to advancing mechanical engineering through innovative design, 
                          manufacturing excellence, and cutting-edge technology solutions."
                        </p>
                        <p className="text-gray-600 leading-relaxed">
                          "We prepare engineers who can design, analyze, and manufacture mechanical systems that drive 
                          modern industry. Our curriculum covers traditional mechanical engineering principles while 
                          embracing emerging technologies like robotics, automation, and sustainable manufacturing."
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <section className="py-16 bg-white">
              <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                  ...
                  <p className="text-xl text-gray-600">Expert educators in mechanical engineering</p>
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-[#B22222] to-[#0097A7] text-white p-8 rounded-xl">
              <p className="text-lg leading-relaxed">
                "To be a globally recognized department of Mechanical Engineering that produces competent 
                professionals with strong technical expertise, innovative design capabilities, and ethical values 
                to serve society and contribute to technological advancement in mechanical systems."
              </p>
            </div>
          </div>
        );
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-[#FFF8F0] p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  To provide quality education in mechanical engineering through innovative 
              ...
              <div className="bg-[#FFF8F0] p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  To promote research and innovation in emerging areas of mechanical engineering 
                  and encourage students to develop advanced manufacturing solutions.
                </p>
              </div>
              <div className="bg-[#FFF8F0] p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  ...
                  practical exposure through internships and manufacturing projects.
                </p>
              </div>
              <div className="bg-[#FFF8F0] p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  ...
                  qualities for successful careers in the mechanical engineering industry.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-[#B22222] pl-6 py-4">
                ...
                <p className="text-gray-700">
                  Graduates will demonstrate professional excellence in mechanical engineering 
                  through successful careers in manufacturing, design, or entrepreneurship.
                </p>
              </div>
              <div className="border-l-4 border-[#0097A7] pl-6 py-4">
                ...
                <p className="text-gray-700">
                  ...
                  advancements and contribute to professional development in mechanical engineering.
                </p>
              </div>
              <div className="border-l-4 border-[#B22222] pl-6 py-4">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-r from-[#B22222]/10 to-[#0097A7]/10 p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  Apply knowledge of mechanical engineering fundamentals, design principles, 
                  and manufacturing processes to solve real-world mechanical engineering problems.
                </p>
              </div>
              <div className="bg-gradient-to-r from-[#0097A7]/10 to-[#B22222]/10 p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  ...
                  mechanical engineering including robotics, automation, and sustainable manufacturing.
                </p>
              </div>
              <div className="bg-gradient-to-r from-[#B22222]/10 to-[#0097A7]/10 p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  ...
                  for successful careers in the mechanical engineering and manufacturing industry.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-[#FFF8F0] p-6 rounded-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="bg-white p-4 rounded-lg shadow">
                  ...
                  <p className="text-sm text-gray-600">Thermodynamics, Fluid Mechanics, Machine Design</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow">
                  <h4 className="font-bold text-[#B22222] mb-2">Advanced Courses</h4>
                  <p className="text-sm text-gray-600">Robotics, CAD/CAM, Advanced Manufacturing</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow">
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                <Cog className="w-12 h-12 text-[#B22222] mb-4" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center mb-6">
                <Cog className="w-16 h-16 text-[#FFF8F0] mr-4" />
                <div>
                  <h1 className="text-4xl md:text-5xl font-bold">Mechanical</h1>
                  <p className="text-xl text-gray-200">Engineering</p>
                </div>
              </div>
              <p className="text-xl leading-relaxed mb-8">
                Engineering the future with innovative mechanical systems, advanced manufacturing technologies, 
                and sustainable design solutions for modern industry.
              </p>
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  <div className="text-3xl font-bold text-[#FFF8F0]">24+</div>
                  <div className="text-sm">Faculty Members</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-[#FFF8F0]">390</div>
                  <div className="text-sm">Students</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-[#FFF8F0]">10</div>
      ...
      <div className="relative">
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="border-b border-gray-200 mb-8">
            <h2 className="text-3xl font-bold text-gray-600 mb-4 text-center">Mechanical Engineering Department</h2>
