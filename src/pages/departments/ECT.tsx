...
const ECTDepartment: React.FC = () => {
  ...
  const faculty = [
    { name: 'Dr. Kavitha Reddy', position: 'Head of Department', qualification: 'Ph.D in Electronics, M.Tech ECE', experience: '22+ years', specialization: 'Communication Systems, Signal Processing', image: 'https://images.pexels.com/photos/3760263/pexels-photo-3760263.jpeg?auto=compress&cs=tinysrgb&w=300' },
    { name: 'Dr. Ravi Shankar', position: 'Professor', qualification: 'Ph.D in VLSI, M.Tech Electronics', experience: '18+ years', specialization: 'VLSI Design, Embedded Systems', image: 'https://images.pexels.com/photos/3785077/pexels-photo-3785077.jpeg?auto=compress&cs=tinysrgb&w=300' },
    { name: 'Prof. Sunita Sharma', position: 'Associate Professor', qualification: 'M.Tech Communication Systems, B.Tech ECE', experience: '14+ years', specialization: 'Wireless Communication, Antenna Design', image: 'https://images.pexels.com/photos/3760055/pexels-photo-3760055.jpeg?auto=compress&cs=tinysrgb&w=300' },
    { name: 'Dr. Manoj Kumar', position: 'Assistant Professor', qualification: 'Ph.D pursuing, M.Tech RF Engineering', experience: '10+ years', specialization: 'RF & Microwave Engineering, IoT', image: 'https://images.pexels.com/photos/2182970/pexels-photo-2182970.jpeg?auto=compress&cs=tinysrgb&w=300' }
  ];
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                      ...
                      <p className="text-gray-600 leading-relaxed">
                        "Welcome to the Department of Electronics and Communication Technology. We are committed to excellence in education, research, and innovation in the rapidly evolving field of electronics and communication."
                      </p>
                    </div>
                  </div>
                </div>
