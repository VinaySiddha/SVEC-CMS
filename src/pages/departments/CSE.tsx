...
const CSEDepartment: React.FC = () => {
  ...
  const faculty = [
    ...
    },
    {
      ...
      position: 'Professor',
      qualification: 'Ph.D in AI, M.Tech CSE',
      experience: '15+ years',
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                      <div className="relative">
                        ...
                        <div className="absolute -bottom-4 -right-4 bg-[#B22222] text-white px-3 py-2 rounded-lg shadow-lg">
                          <p className="font-bold text-sm">20+ Years</p>
                      ...
                      <div className="lg:col-span-2 space-y-4">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                          "Welcome to the Department of Computer Science & Engineering at Sri Vasavi Engineering College. 
                          Our department stands at the forefront of technological innovation, offering comprehensive education 
                          in computing, artificial intelligence, and software engineering."
                        </p>
                        <p className="text-gray-600 leading-relaxed">
                          "We are committed to nurturing the next generation of computer scientists and engineers who will 
                          shape the digital future. Our curriculum is designed to provide both theoretical foundations and 
                          practical skills necessary for success in the rapidly evolving tech industry."
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <section className="py-16 bg-white">
              <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                  ...
                  <p className="text-xl text-gray-600">Experienced educators and researchers</p>
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-[#B22222] to-[#0097A7] text-white p-8 rounded-xl">
              <p className="text-lg leading-relaxed">
                "To be a globally recognized department of Computer Science & Engineering that produces competent 
                professionals with strong ethical values, innovative thinking, and leadership qualities to serve 
                society and contribute to technological advancement."
              </p>
            </div>
          </div>
        );
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-[#FFF8F0] p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  To provide quality education in computer science and engineering through innovative 
              ...
              <div className="bg-[#FFF8F0] p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  To promote research and innovation in emerging areas of computer science and 
                  encourage students to develop solutions for real-world problems.
                </p>
              </div>
              <div className="bg-[#FFF8F0] p-6 rounded-xl">
              ...
              <div className="bg-[#FFF8F0] p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  ...
                  qualities for successful careers in the global technology landscape.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-[#B22222] pl-6 py-4">
                ...
                <p className="text-gray-700">
                  Graduates will demonstrate professional excellence in computer science and engineering 
                  through successful careers in industry, academia, or entrepreneurship.
                </p>
              </div>
              <div className="border-l-4 border-[#0097A7] pl-6 py-4">
                ...
                <p className="text-gray-700">
                  ...
                  advancements and contribute to professional development.
                </p>
              </div>
              <div className="border-l-4 border-[#B22222] pl-6 py-4">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-r from-[#B22222]/10 to-[#0097A7]/10 p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  Apply knowledge of computer science fundamentals, programming languages, and 
                  software engineering principles to solve real-world problems.
                </p>
              </div>
              <div className="bg-gradient-to-r from-[#0097A7]/10 to-[#B22222]/10 p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  ...
                  computer science including AI, machine learning, and data science.
                </p>
              </div>
              <div className="bg-gradient-to-r from-[#B22222]/10 to-[#0097A7]/10 p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  ...
                  for successful careers in the global technology industry.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-[#FFF8F0] p-6 rounded-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="bg-white p-4 rounded-lg shadow">
                  ...
                  <p className="text-sm text-gray-600">Programming, Data Structures, Algorithms</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow">
                  <h4 className="font-bold text-[#B22222] mb-2">Advanced Courses</h4>
                  <p className="text-sm text-gray-600">AI, ML, Database Systems</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl leading-relaxed mb-8">
                Leading the digital revolution with cutting-edge computing technologies, 
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                ...
                <div>
                  <div className="text-3xl font-bold text-[#FFF8F0]">480</div>
      ...
      <div className="relative">
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="border-b border-gray-200 mb-8">
            <h2 className="text-3xl font-bold text-gray-600 mb-4 text-center">CSE Department</h2>
