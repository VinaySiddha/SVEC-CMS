  ...
  const faculty = [
    {
      ...
      qualification: 'Ph.D in Structural Engineering, M.Tech Civil',
      experience: '25+ years',
    ...
    },
    {
      name: 'Dr. Sita Devi',
      position: 'Professor',
      qualification: 'Ph.D in Environmental Engineering, M.Tech Civil',
      experience: '21+ years',
    ...
    },
    {
      ...
      qualification: 'M.Tech Transportation, B.Tech Civil',
      experience: '16+ years',
    ...
    },
    {
      ...
      qualification: 'Ph.D pursuing, M.Tech Civil',
      experience: '11+ years',
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                      <div className="relative">
                        ...
                        <div className="absolute -bottom-4 -right-4 bg-[#B22222] text-white px-3 py-2 rounded-lg shadow-lg">
                          <p className="font-bold text-sm">25+ Years</p>
                      ...
                      <div className="lg:col-span-2 space-y-4">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                          "Welcome to the Department of Civil Engineering at Sri Vasavi Engineering College. 
                          Our department is committed to building the future through innovative infrastructure design, 
                          sustainable construction practices, and comprehensive engineering education."
                        </p>
                        <p className="text-gray-600 leading-relaxed">
                          "We prepare engineers who can design and construct the infrastructure that society depends on - 
                          from buildings and bridges to water systems and transportation networks. Our curriculum emphasizes 
                          both traditional civil engineering principles and modern sustainable practices."
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <section className="py-16 bg-white">
              <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                  ...
                  <p className="text-xl text-gray-600">Experienced professionals in civil engineering</p>
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-[#B22222] to-[#0097A7] text-white p-8 rounded-xl">
              <p className="text-lg leading-relaxed">
                "To be a globally recognized department of Civil Engineering that produces competent 
                professionals with strong technical skills, innovative thinking, and sustainable practices 
                to build a better tomorrow for society."
              </p>
            </div>
          </div>
        );
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-[#FFF8F0] p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  To provide quality education in civil engineering through innovative 
              ...
              <div className="bg-[#FFF8F0] p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  To promote research and innovation in emerging areas of civil engineering 
                  and encourage students to develop sustainable infrastructure solutions.
                </p>
              </div>
              <div className="bg-[#FFF8F0] p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  ...
                  practical exposure through internships and construction projects.
                </p>
              </div>
              <div className="bg-[#FFF8F0] p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  ...
                  qualities for successful careers in the construction and infrastructure industry.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-[#B22222] pl-6 py-4">
                ...
                <p className="text-gray-700">
                  Graduates will demonstrate professional excellence in civil engineering 
                  through successful careers in construction, infrastructure, or entrepreneurship.
                </p>
              </div>
              <div className="border-l-4 border-[#0097A7] pl-6 py-4">
                ...
                <p className="text-gray-700">
                  ...
                  advancements and contribute to professional development in civil engineering.
                </p>
              </div>
              <div className="border-l-4 border-[#B22222] pl-6 py-4">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-r from-[#B22222]/10 to-[#0097A7]/10 p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  Apply knowledge of civil engineering fundamentals, structural analysis, 
                  and construction management to solve real-world infrastructure problems.
                </p>
              </div>
              <div className="bg-gradient-to-r from-[#0097A7]/10 to-[#B22222]/10 p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  ...
                  civil engineering including sustainable construction and smart infrastructure.
                </p>
              </div>
              <div className="bg-gradient-to-r from-[#B22222]/10 to-[#0097A7]/10 p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  ...
                  for successful careers in the construction and infrastructure industry.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-[#FFF8F0] p-6 rounded-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="bg-white p-4 rounded-lg shadow">
                  ...
                  <p className="text-sm text-gray-600">Structural Analysis, Concrete Technology, Surveying</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow">
                  <h4 className="font-bold text-[#B22222] mb-2">Advanced Courses</h4>
                  <p className="text-sm text-gray-600">Earthquake Engineering, Green Buildings, Smart Cities</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow">
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                <Building className="w-12 h-12 text-[#B22222] mb-4" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h1 className="text-4xl md:text-5xl font-bold">Civil</h1>
                  <p className="text-xl text-gray-200">Engineering</p>
                </div>
              </div>
              <p className="text-xl leading-relaxed mb-8">
                Building the future with innovative infrastructure solutions, sustainable construction practices, 
                and comprehensive engineering expertise for modern society.
              </p>
              <div className="grid grid-cols-3 gap-4 text-center">
                ...
                <div>
                  <div className="text-3xl font-bold text-[#FFF8F0]">420</div>
                  <div className="text-sm">Students</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-[#FFF8F0]">9</div>
      ...
      <div className="relative">
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="border-b border-gray-200 mb-8">
            <h2 className="text-3xl font-bold text-gray-600 mb-4 text-center">Civil Engineering Department</h2>
