...
const CSTDepartment: React.FC = () => {
  ...
  const faculty = [
    { name: 'Dr. Suresh Babu', position: 'Head of Department', qualification: 'Ph.D in Computer Science, M.Tech CSE', experience: '26+ years', specialization: 'Software Engineering, Database Systems', image: 'https://images.pexels.com/photos/2182970/pexels-photo-2182970.jpeg?auto=compress&cs=tinysrgb&w=300' },
    { name: 'Dr. Vasantha Kumari', position: 'Professor', qualification: 'Ph.D in Computer Technology, M.Tech IT', experience: '20+ years', specialization: 'Web Technologies, Mobile Computing', image: 'https://images.pexels.com/photos/3760263/pexels-photo-3760263.jpeg?auto=compress&cs=tinysrgb&w=300' },
    { name: 'Prof. Ramesh Kumar', position: 'Associate Professor', qualification: 'M.Tech Computer Science, B.Tech CSE', experience: '16+ years', specialization: 'Cloud Computing, Network Security', image: 'https://images.pexels.com/photos/3785077/pexels-photo-3785077.jpeg?auto=compress&cs=tinysrgb&w=300' },
    { name: 'Dr. Priya Nair', position: 'Assistant Professor', qualification: 'Ph.D pursuing, M.Tech CST', experience: '12+ years', specialization: 'Cybersecurity, Blockchain Technology', image: 'https://images.pexels.com/photos/3760055/pexels-photo-3760055.jpeg?auto=compress&cs=tinysrgb&w=300' }
  ];
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                      ...
                      <p className="text-gray-600 leading-relaxed">
                        "Welcome to the Department of Computer Science & Technology. We are committed to providing comprehensive education in computer science with a strong emphasis on emerging technologies and practical applications."
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl leading-relaxed">
                Empowering the next generation of technology professionals through comprehensive computer science education and innovation.
              </p>
            </div>
            <div>
              <img 
