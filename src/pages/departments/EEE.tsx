  ...
  const faculty = [
    {
      ...
      qualification: 'Ph.D in Power Systems, M.Tech EEE',
      experience: '23+ years',
    ...
    },
    {
      ...
      position: 'Professor',
      qualification: 'Ph.D in Control Systems, M.Tech EEE',
      experience: '20+ years',
    ...
    },
    {
      ...
      qualification: 'Ph.D pursuing, M.Tech EEE',
      experience: '10+ years',
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                      <div className="relative">
                        ...
                        <div className="absolute -bottom-4 -right-4 bg-[#B22222] text-white px-3 py-2 rounded-lg shadow-lg">
                          <p className="font-bold text-sm">23+ Years</p>
                      ...
                      <div className="lg:col-span-2 space-y-4">
                        ...
                        <p className="text-gray-600 leading-relaxed">
                          "Welcome to the Department of Electrical & Electronics Engineering at Sri Vasavi Engineering College. 
                          Our department is dedicated to advancing the field of electrical engineering through innovative research, 
                          comprehensive education, and practical applications in power systems and electronics."
                        </p>
                        <p className="text-gray-600 leading-relaxed">
                          "We strive to produce competent engineers who can address the challenges of modern electrical systems, 
                          renewable energy, and smart grid technologies. Our curriculum balances theoretical knowledge with 
                          hands-on experience to prepare students for successful careers in the electrical industry."
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-[#B22222] to-[#0097A7] text-white p-8 rounded-xl">
              <p className="text-lg leading-relaxed">
                "To be a globally recognized department of Electrical & Electronics Engineering that produces competent 
                professionals with strong technical skills, ethical values, and innovative thinking to serve society 
                and contribute to sustainable technological development."
              </p>
            </div>
          </div>
        );
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-[#FFF8F0] p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  To provide quality education in electrical and electronics engineering through innovative 
              ...
              <div className="bg-[#FFF8F0] p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  To promote research and innovation in emerging areas of electrical engineering and 
                  encourage students to develop solutions for power and energy challenges.
                </p>
              </div>
              <div className="bg-[#FFF8F0] p-6 rounded-xl">
              ...
              <div className="bg-[#FFF8F0] p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  ...
                  qualities for successful careers in the electrical industry.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-[#B22222] pl-6 py-4">
                ...
                <p className="text-gray-700">
                  Graduates will demonstrate professional excellence in electrical and electronics engineering 
                  through successful careers in industry, power sector, or entrepreneurship.
                </p>
              </div>
              <div className="border-l-4 border-[#0097A7] pl-6 py-4">
                ...
                <p className="text-gray-700">
                  ...
                  advancements and contribute to professional development in electrical engineering.
                </p>
              </div>
              <div className="border-l-4 border-[#B22222] pl-6 py-4">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-r from-[#B22222]/10 to-[#0097A7]/10 p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  Apply knowledge of electrical and electronics engineering fundamentals, power systems, 
                  and control systems to solve real-world electrical engineering problems.
                </p>
              </div>
              <div className="bg-gradient-to-r from-[#0097A7]/10 to-[#B22222]/10 p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  ...
                  electrical engineering including renewable energy, smart grids, and power electronics.
                </p>
              </div>
              <div className="bg-gradient-to-r from-[#B22222]/10 to-[#0097A7]/10 p-6 rounded-xl">
                ...
                <p className="text-gray-700">
                  ...
                  for successful careers in the electrical and power industry.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-[#FFF8F0] p-6 rounded-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="bg-white p-4 rounded-lg shadow">
                  ...
                  <p className="text-sm text-gray-600">Circuit Analysis, Power Systems, Control Systems</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow">
                  <h4 className="font-bold text-[#B22222] mb-2">Advanced Courses</h4>
                  <p className="text-sm text-gray-600">Power Electronics, Smart Grids, Renewable Energy</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow">
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                <Zap className="w-12 h-12 text-[#B22222] mb-4" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl leading-relaxed mb-8">
                Powering the future with innovative electrical systems, renewable energy solutions, 
                and cutting-edge electronics technology.
              </p>
              <div className="grid grid-cols-3 gap-4 text-center">
                ...
                <div>
                  <div className="text-3xl font-bold text-[#FFF8F0]">360</div>
      ...
      <div className="relative">
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="border-b border-gray-200 mb-8">
            <h2 className="text-3xl font-bold text-gray-600 mb-4 text-center">EEE Department</h2>
