...
const ECEDepartment: React.FC = () => {
  ...
  const faculty = [
    { name: 'Dr. Suresh Reddy', position: 'Head of Department', qualification: 'Ph.D in Communication Systems, M.Tech ECE', experience: '22+ years', specialization: 'Wireless Communications, Signal Processing', image: 'https://images.pexels.com/photos/2182970/pexels-photo-2182970.jpeg?auto=compress&cs=tinysrgb&w=300' },
    { name: 'Dr. Kavitha Rani', position: 'Professor', qualification: 'Ph.D in VLSI Design, M.Tech ECE', experience: '18+ years', specialization: 'VLSI Design, Embedded Systems', image: 'https://images.pexels.com/photos/3760263/pexels-photo-3760263.jpeg?auto=compress&cs=tinysrgb&w=300' },
    { name: 'Prof. Ravi Kumar', position: 'Associate Professor', qualification: 'M.Tech Electronics, B.Tech ECE', experience: '14+ years', specialization: 'Digital Signal Processing, Microprocessors', image: 'https://images.pexels.com/photos/3785077/pexels-photo-3785077.jpeg?auto=compress&cs=tinysrgb&w=300' },
    { name: 'Dr. Priya Kumari', position: 'Assistant Professor', qualification: 'Ph.D pursuing, M.Tech ECE', experience: '9+ years', specialization: 'IoT, Wireless Sensor Networks', image: 'https://images.pexels.com/photos/3760055/pexels-photo-3760055.jpeg?auto=compress&cs=tinysrgb&w=300' }
  ];
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                      ...
                      <p className="text-gray-600 leading-relaxed">
                        "Welcome to the Department of Electronics & Communication Engineering. Our department is at the forefront of technological innovation in communications, VLSI design, and embedded systems, preparing students for the digital age."
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl leading-relaxed">
                Connecting the world through advanced communication systems, VLSI design, and innovative electronic solutions.
              </p>
            </div>
            <div>
              <img 
