...
const BSHDepartment: React.FC = () => {
  ...
  const faculty = [
    { name: 'Dr. Priya Sharma', position: 'Head of Department', qualification: 'Ph.D in Applied Mathematics, M.Sc Mathematics', experience: '26+ years', specialization: 'Applied Mathematics, Statistics', image: 'https://images.pexels.com/photos/3760263/pexels-photo-3760263.jpeg?auto=compress&cs=tinysrgb&w=300' },
    { name: 'Dr. Rajesh Verma', position: 'Professor - Physics', qualification: 'Ph.D in Physics, M.Sc Physics', experience: '21+ years', specialization: 'Quantum Physics, Optics', image: 'https://images.pexels.com/photos/3785077/pexels-photo-3785077.jpeg?auto=compress&cs=tinysrgb&w=300' },
    { name: 'Prof. Lakshmi Devi', position: 'Professor - Chemistry', qualification: 'M.Sc Chemistry, M.Phil Chemistry', experience: '16+ years', specialization: 'Organic Chemistry, Environmental Chemistry', image: 'https://images.pexels.com/photos/3760055/pexels-photo-3760055.jpeg?auto=compress&cs=tinysrgb&w=300' },
    { name: 'Dr. Anil Kumar', position: 'Associate Professor - English', qualification: 'Ph.D in English Literature, MA English', experience: '13+ years', specialization: 'Technical Communication, Literature', image: 'https://images.pexels.com/photos/2182970/pexels-photo-2182970.jpeg?auto=compress&cs=tinysrgb&w=300' }
  ];
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                      ...
                      <p className="text-gray-600 leading-relaxed">
                        "Welcome to the Department of Basic Sciences and Humanities. Our department serves as the foundation for all engineering disciplines, providing strong fundamentals in mathematics, physics, chemistry, and humanities."
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl leading-relaxed">
                Building strong foundations in mathematics, physics, chemistry, and humanities to create well-rounded engineers.
              </p>
            </div>
            <div>
              <img 
