          ...
          <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
              ...
              <div className="lg:col-span-2 space-y-4">
                <div className="mb-4">
                  <h3 className="text-2xl font-bold text-primary mb-2">Sri N. Raja Sekhar</h3>
                  <p className="text-lg text-muted-foreground font-medium mb-2">Head of the Department</p>
        ...
        <div className="lg:hidden fixed top-20 left-0 right-0 bg-white shadow-md z-40">
          <div className="container mx-auto px-4 py-3 flex justify-between items-center">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-bold text-lg text-primary">BSH Department</span>
            </div>
