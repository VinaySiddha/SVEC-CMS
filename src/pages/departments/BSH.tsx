...
const BSHDepartment: React.FC = () => {
  ...
  const hodInfo = {
    ...
    designation: "Associate Professor & Head of Department, BSH",
    education: "M.Sc., M.Phil in Mathematics",
  ...
  const departmentContent = {
    Department: (
      <div className="space-y-6">
        ...
        <p className="text-gray-700 mb-3 text-justify">
          Our department focuses on developing analytical thinking, problem-solving skills, and communication abilities essential for engineering success.
        </p>
      </div>
    ),
    Vision: (
      <div>
        ...
        <p className="text-gray-700 text-justify">
          To excel in providing quality education in basic sciences and humanities, fostering analytical thinking and communication skills among students to support their engineering education and professional development.
        </p>
      </div>
    ),
    Mission: (
      <div>
        ...
        <ul className="list-disc pl-5 space-y-2 text-gray-700">
          <li>To provide strong foundation in Mathematics, Physics, Chemistry, and English</li>
          <li>To develop analytical and problem-solving skills among students</li>
          <li>To enhance communication and technical writing capabilities</li>
          <li>To support interdisciplinary learning and research</li>
        </ul>
      </div>
    ),
    PEOs: (
      <div>
        ...
        <p className="text-gray-700 mb-4">The BSH graduates will:</p>
        <div className="space-y-4">
          <div className="p-4 bg-gray-50 rounded-lg shadow-sm">
            <h4 className="text-lg font-semibold text-blue-800">PEO 1</h4>
            <p className="text-gray-700">Apply mathematical and scientific principles to solve complex engineering problems.</p>
          </div>
          <div className="p-4 bg-gray-50 rounded-lg shadow-sm">
            <h4 className="text-lg font-semibold text-blue-800">PEO 2</h4>
            <p className="text-gray-700">Demonstrate effective communication skills in technical and professional environments.</p>
          </div>
          <div className="p-4 bg-gray-50 rounded-lg shadow-sm">
            <h4 className="text-lg font-semibold text-blue-800">PEO 3</h4>
            <p className="text-gray-700">Exhibit analytical thinking and problem-solving capabilities.</p>
          </div>
        </div>
      </div>
    ),
      ...
      <div>
        ...
        <div className="space-y-3">
          <div className="p-3 bg-gray-50 rounded-lg shadow-sm">
            <h4 className="text-md font-semibold text-blue-800">PO1: Mathematical Foundation</h4>
      ...
      <div>
        ...
        <div className="space-y-4">
          <div className="p-4 bg-gray-50 rounded-lg shadow-sm">
            ...
            <p className="text-gray-700">Apply mathematical tools and techniques for engineering analysis and design.</p>
          </div>
          <div className="p-4 bg-gray-50 rounded-lg shadow-sm">
            <h4 className="text-lg font-semibold text-blue-800">PSO 2</h4>
            <p className="text-gray-700">Demonstrate proficiency in scientific methodology and experimentation.</p>
          </div>
        </div>
      </div>
    ),
    COs: (
      <div>
        ...
        <p className="text-gray-700 mb-4">
          Course outcomes for BSH subjects are designed to build strong foundation in basic sciences and communication skills essential for engineering education.
        </p>
      </div>
    ),
    "Salient Features": (
      <div>
        ...
        <ul className="list-disc pl-5 space-y-2 text-gray-700">
          <li>Experienced faculty in Mathematics, Physics, Chemistry, and English</li>
          <li>Well-equipped laboratories for Physics and Chemistry</li>
          <li>Student-centric teaching methodologies</li>
          <li>Regular faculty development programs</li>
          <li>Strong emphasis on fundamental concepts</li>
