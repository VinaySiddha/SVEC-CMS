...
export default async function handler(
  ...
  try {
    ...
    if (req.method === 'GET') {
      ...
      const { name, qualification, designation, profileUrl, faculty_type, date_of_joining } = req.body;
      ...
      const [result]: any = await connection.execute(
        `INSERT INTO ect_faculty (name, qualification, designation, profileUrl, faculty_type, date_of_joining) 
         VALUES (?, ?, ?, ?, ?, ?)`,
        [
          name,
          qualification || null,
